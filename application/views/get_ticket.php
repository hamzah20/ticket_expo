									...
									<div class="col-12">
										...
										<div class="card card-custom card-stretch gutter-b">
											...
											<ul class="nav nav-tabs mt-5 mx-5">
												<li class="nav-item">
													<a class="nav-link active" aria-current="page" href="#">Get Tickets</a>
												</li>
												<li class="nav-item">
													<a class="nav-link" href="<?php echo base_url('list_ticket');?>">List Tickets</a>
												</li> 
												<li class="nav-item">
													<a class="nav-link" href="location_booth.php">Location</a>
												</li> 
											</ul>
											...
											<div class="card-body pt-2 pb-0 mt-n3">
												<div class="tab-content mt-5" id="myTabTables11"> 
													...
													<div class="tab-pane fade show active" id="kt_tab_pane_11_3" role="tabpanel" aria-labelledby="kt_tab_pane_11_3">
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody>
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Harvard University</a>
																					<div>
																						<span class="font-weight-bolder">Negara: UK</span> 
																					</div>
																				</td> 
																				<td>
																					<h2><span class="badge badge-secondary">004</span></h2>
																				</td>
																				<td class="text-right">
																	...
																	<table class="table table-borderless table-vertical-center">
																		...
																		<tbody> 
																			<tr>
																				...
																				<td class="pl-0">
																					<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Stanford University</a>
																					<div>
														...
														<!--end::Table-->
														<?php
															include('modal/accept_ticket.php');
														?>
													</div>
													<!--end::Tap pane-->
												</div>
